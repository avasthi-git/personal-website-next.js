...
export default function Layout({ children }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-screen h-screen text-gray-800 transition duration-1000 ease-in-out dark:text-white dark:bg-blueGray-700">
      <Head>
        <title>Ishan Avasthi</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <script defer data-domain="ishanavasthi.co.in" src="https://plausible.io/js/plausible.js"></script>
        <script async src="https://arc.io/widget.min.js#AyLjV5gi"></script>
        <script src="https://cdn.jsdelivr.net/gh/avasthi-git/avasthi-git.github.io@main/contact-form.js" id="contactform" form_worker_url="https://form.dragonmirror.workers.dev/"></script>
      </Head>
      <div
      ...
      >
        ...
        <motion.div layoutId="social-icons" className="flex items-center justify-center">
          <a
            ...
            href="https://github.com/avasthi-git"
            target="_blank"
          >
          ...
          <a
            className="text-gray-400 dark:text-white hover:text-lightBlue-600 dark:hover:text-pink-500"
            href="https://twitter.com/heyavasthi"
            target="_blank"
          >
          ...
          <a
            className="text-gray-400 dark:text-white hover:text-lightBlue-600 dark:hover:text-pink-500"
            href="https://www.linkedin.com/in/heyavasthi/"
            target="_blank"
          >
          ...
          <a
            className="text-gray-400 dark:text-white hover:text-lightBlue-600 dark:hover:text-pink-500"
            href="https://blog.ishanavasthi.co.in"
            target="_blank"
          >
